...
module.exports.settings = function () {
  ...
  if (config_file != "") {
      ...
      return {
        ...
        avrgccDefaultCFlags: config_data.avrDevice,
        avrgccDefaultCFlags: config_data.avrDeviceFrequency,
      ...
      return {
          ...
          avrgccDefaultCFlags: atom.config.get("linter-gcc-with-avr.avrDevice"),
          avrgccDefaultCFlags: atom.config.get("linter-gcc-with-avr.avrDeviceFrequency"),
